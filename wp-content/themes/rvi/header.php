...
<script src="http://localhost:8888/rvi-group-phase2-new/wp-content/themes/Simplepress-Child/js/flexi-slider.js"></script>
</head>
<body <?php body_class(); ?>>
...
<div class="nav-container">
  <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php $logo = (get_option('simplepress_logo') <> '') ? get_option('simplepress_logo') : get_template_directory_uri().'/images/logo.png'; ?>
    <img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" id="logo" class="slideDown"/></a>
