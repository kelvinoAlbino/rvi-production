...
<div class="nav-container">
  <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php $logo = (get_option('simplepress_logo') <> '') ? get_option('simplepress_logo') : get_template_directory_uri().'/images/logo.png'; ?>
    <?php $engineerVentLogo = get_template_directory_uri() . '/images/rvi_group_engvent_logo.png' ?>
    <img src="<?php echo esc_attr($engineerVentLogo)?>" id="logo-divisions" class="slideDown"/></a>
